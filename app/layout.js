import 'bootstrap/dist/css/bootstrap.min.css'; // ← 1er
import './globals.css';                          // ← 2ème
...
export const metadata = {
  ...
  keywords: [
    'développeur java-fullstack', 'React', 'Next.js',
    'NestJS', 'Java', 'Node.js', 'Docker', 'DevOps', 'freelance',
  ],
  ...
  openGraph: {
    ...
    description: 'Portfolio de MEYOGHE Melvine Joêl, développeur Java-Fullstack spécialisé React, Next.js, NestJS et Docker.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'MEYOGHE Melvine Joêl — Java-Fullstack Developer' }],
  },
  twitter: {
